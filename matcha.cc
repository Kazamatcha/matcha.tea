...
local function showConsole()
    ...
    titleText2.Text                   = "Administrator: Anhchangm52"
    ...
    inputBox.FocusLost:Connect(function(enterPressed)
        ...
        if enterPressed then
            if typedKey == correctKey then
                ...
                keyLabel2.Text = '[<font color="rgb(255,0,0)">-</font>] Authenticating Your <font color="rgb(255,0,0)">Matcha</font> Key...'
                wait(authDelay)
                repeat task.wait() until otherThingLoaded
                keyLabel2.Text = '[<font color="rgb(255,0,0)">-</font>] Hiding <font color="rgb(255,0,0)">Matcha</font> Console From The Game <font color="rgb(255,0,0)">3.00</font> seconds'
                wait(hideDelay)
                ...
                keyLabel2.Text = '[<font color="rgb(255,0,0)">-</font>] Your Matcha Key is Invalid'
                wait(3)
                inputBox.Text = ""
                typedKey = ""
                updateKeyLabel()
...
local SilentAim = Matcha["Silent Aim"]
local RangeCfg  = Matcha["Range"] or {}
...
local player = Players.LocalPlayer
local opts = getgenv().Matcha["Speed Modifications"].Options
...
local Camlock = getgenv().Matcha['Camlock']
...
-- Range settings
local RangeSettings = getgenv().Matcha['Range']
